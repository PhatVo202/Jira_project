import { Avatar, Breadcrumb, Button, Form, Input, Space, notification } from 'antd'
      ...
      <div className='container py-5'>
        <div className='row'>
          <div className='col-12 text-center col-sm-12 text-md-center col-lg-5'>
            <Avatar style={{ width: '300px', height: '300px' }} src={userhookState?.userInfo?.avatar} />
          </div>
            ...
            >
              ...
              <div style={{ textAlign: 'right' }}>
                <Space className='my-5'>
                  <Button onClick={() => navigate('/jira/projectmanagement')}>Cancel</Button>
